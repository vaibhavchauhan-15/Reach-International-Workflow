...
const Footer = React.memo(function Footer({ currentSlide, totalSlides, prevSlide, nextSlide, goToSlide }) {
    return (
        <footer className="slide-footer">
            <button className="nav-arrow-btn" onClick={prevSlide} title="Previous Slide (Left Arrow)" aria-label="Previous Slide">
            ...
            <button className="nav-arrow-btn primary-nav-btn" onClick={nextSlide} title="Next Slide (Right Arrow)" aria-label="Next Slide">
