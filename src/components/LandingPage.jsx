...
export default function LandingPage({ setActivePage }) {
    return (
        <div className="flex-1 w-full h-full overflow-y-auto scrollbar-none max-w-4xl mx-auto px-4 sm:px-6 md:px-8 py-4 sm:py-6 md:py-8 flex flex-col justify-center gap-6 md:gap-8 animate-fade-in">
            {/* Title Banner */}
